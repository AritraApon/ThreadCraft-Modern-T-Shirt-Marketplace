...
export default function ManageProductsTable() {
  ...
  return (
    <div className="w-full space-y-4">
      ...
      <DeleteConfirmModal isOpen={isDeleteOpen} onClose={() => setIsDeleteOpen(false)} productId={selectedProduct?._id} productTitle={selectedProduct?.title} onSuccess={fetchProducts} />
    </div>
  );
}